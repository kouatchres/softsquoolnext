...
const DropdownMenu = () => {
  const [activeMenu, setActiveMenu] = useState('levelOne')
  ...
  const levelOneMenu = [
    {
      rightIcon: <NavigateNextTwoToneIcon />,
      leftIcon: <BuildTwoToneIcon />,
      gotoMenu: 'candidate',
      title: 'Candidate',
    },
    {
      rightIcon: <NavigateNextTwoToneIcon />,
      leftIcon: <BugReportTwoToneIcon />,
      gotoMenu: 'examiner',
      title: 'Examiner',
    },
    {
