# Migration `20210430115509-all-changes`

This migration has been generated by Kouatchoua Mark at 4/30/2021, 12:55:10 PM.
...
migration 20210430041033-randomatic..20210430115509-all-changes
--- datamodel.dml
+++ datamodel.dml
@@ -1,266 +1,266 @@
-datasource db {
...
+  id               String    @id @default(cuid())
+  schoolName       String
+  schoolPublicCode String    @unique
...
+  gender              String
+  email               String
+  studentMatricule    String                @unique
+  image               String
